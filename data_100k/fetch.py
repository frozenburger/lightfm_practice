...
def movielens():
    ...
    ratings_data = ratings_data.pivot(index=0, columns=1, values=2).fillna(0)
    ratings_data.values[4 <= ratings_data.values] = 0
    ratings_data.values[ratings_data.values <= 3] = 1
